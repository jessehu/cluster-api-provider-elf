...
func (m *MockVMService) Get(uuid string) (*models.VM, error) {
	m.ctrl.T.Helper()
...
func (m *MockVMService) GetCluster(clusterId string) (*models.Cluster, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVMServiceMockRecorder) GetCluster(clusterId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCluster", reflect.TypeOf((*MockVMService)(nil).GetCluster), clusterId)
}

// GetTask mocks base method.
func (m *MockVMService) GetTask(taskId string) (*models.Task, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVMServiceMockRecorder) GetTask(taskId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTask", reflect.TypeOf((*MockVMService)(nil).GetTask), taskId)
}
...
func (m *MockVMService) GetVlan(vlanId string) (*models.Vlan, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetVlan", vlanId)
...
func (mr *MockVMServiceMockRecorder) GetVlan(vlanId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetVlan", reflect.TypeOf((*MockVMService)(nil).GetVlan), vlanId)
}
