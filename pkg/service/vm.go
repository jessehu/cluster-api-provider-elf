...
type VMService interface {
	...
	GetCluster(clusterId string) (*models.Cluster, error)
	GetVlan(vlanId string) (*models.Vlan, error)
}
...
func (svr *TowerVMService) Delete(uuid string) (*models.Task, error) {
	...
	deleteVMParams.RequestBody = &models.VMOperateParams{
		Where: &models.VMWhereInput{LocalID: &uuid},
	}
